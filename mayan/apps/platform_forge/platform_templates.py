...
from mayan.apps.platform.classes import PlatformTemplate, Variable
from mayan.settings.literals import (
    ...
    FORGE_TRANSIFEX_VERSION, LINUX_PACKAGES_DEBIAN_BASE,
    LINUX_PACKAGES_DEBIAN_BUILD, LINUX_PACKAGES_DEBIAN_DOCUMENTATION,
    LINUX_PACKAGES_DEBIAN_FORGE, LINUX_PACKAGES_DEBIAN_MYSQL,
    LINUX_PACKAGES_DEBIAN_POSTGRESQL, LINUX_PACKAGES_DEBIAN_PUSH,
...
PlatformTemplate.register(klass=PlatformTemplateForgeDockerComposefile)
PlatformTemplate.register(klass=PlatformTemplateForgeDockerfile)
