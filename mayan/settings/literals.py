...
DOCKER_POSTGRESQL_IMAGE_TAG = '13.21-alpine'
...
FORGE_DOCKER_BASE_IMAGE_TAG = '24.04'
...
GUNICORN_WORKERS = 3
LINUX_PACKAGES_DEBIAN_BASE = 'ca-certificates clamav file fuse ghostscript git gnupg1 graphviz less libarchive-zip-perl libfile-mimeinfo-perl libimage-exiftool-perl libmariadb3 libpq5 libreoffice-calc-nogui libreoffice-draw-nogui libreoffice-impress-nogui libreoffice-math-nogui libreoffice-writer-nogui poppler-utils sane-utils software-properties-common sudo supervisor tesseract-ocr'
...
PYTHON_PIP_VERSION = '24.3'
PYTHON_PSYCOPG_VERSION = '3.1.20'
