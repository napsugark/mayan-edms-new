...
DOCKER_REDIS_IMAGE_TAG = '7.2.10-alpine3.21'
DOCKER_TRAEFIK_IMAGE_NAME = 'traefik'
DOCKER_TRAEFIK_IMAGE_TAG = 'v2.5.7'
DOCKER_USER_UID = 1000
DOCKER_USER_GID = 1000
DOCKER_FORGE_BASE_IMAGE_NAME = 'ubuntu'
DOCKER_FORGE_BASE_IMAGE_TAG = '24.04'
DOCKER_FORGE_IMAGE_NAME = 'mayanedms/mayanforge'
...
LINUX_PACKAGES_DEBIAN_FORGE = 'bash-completion curl vim virtualenvwrapper'
