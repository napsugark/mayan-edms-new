...
DOCKER_ELASTIC_IMAGE_TAG = '7.17.28'
...
DOCKER_LINUX_IMAGE_VERSION = 'debian:12.11-slim'
...
FORGE_DOCKER_BASE_IMAGE_TAG = 'noble-20250714'
...
GUNICORN_WORKERS = 3
LINUX_PACKAGES_DEBIAN_BASE = 'ca-certificates clamav file fuse ghostscript git gnupg1 graphviz less libarchive-zip-perl libfile-mimeinfo-perl libimage-exiftool-perl libmariadb3 libpq5 libreoffice-calc-nogui libreoffice-draw-nogui libreoffice-impress-nogui libreoffice-math-nogui libreoffice-writer-nogui poppler-utils sane-utils sudo supervisor tesseract-ocr'
LINUX_PACKAGES_DEBIAN_BUILD = 'g++ gcc libffi-dev libjpeg-dev libldap2-dev libpng-dev libsasl2-dev libssl-dev libtiff-dev make software-properties-common zlib1g-dev'
LINUX_PACKAGES_DEBIAN_DOCUMENTATION = 'enchant-2 libcairo2'
LINUX_PACKAGES_DEBIAN_FORGE = 'bash-completion curl less vim virtualenvwrapper'
